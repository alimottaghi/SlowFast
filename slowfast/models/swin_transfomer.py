...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        relative_position_bias = self.relative_position_bias_table[self.relative_position_index.clone().view(-1)].view(
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.img_size = (cfg.DATA.TRAIN_CROP_SIZE, cfg.DATA.TRAIN_CROP_SIZE)
        ...
        self.window_size = max(cfg.SWIN.WINDOW_SIZE)
        ...
        self.norm_layer = nn.LayerNorm if cfg.SWIN.NORM_LAYER=='layernorm' else nn.Identity
        self.patch_norm = cfg.SWIN.PATCH_NORM
        self.frozen_stages = cfg.SWIN.FROZEN_STAGES
        self.use_checkpoint = cfg.SWIN.USE_CHECKPOINT
        self.ape = cfg.SWIN.APE
        self.fused_window_process = cfg.SWIN.FUSED_WINDOW_PROCESS
